...
public class UiAlertas {
    public static final Target BTN_CLICK = Target.the("Boton para abrir alerta").located(By.xpath("//div[@id='javascriptAlertsWrapper']//button[@id='alertButton']"));
