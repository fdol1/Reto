...
public class Constantes {
    public static final String URL_PORTAL = "https://demoqa.com/";
    public static final String OPCION_ELEMENT = "Elements";
    public static final String OPCION_WIDGET = "Widgets";
    ...
    public static final String OPCION_CLICK_CONFIRMAR = "Click y confirmar";
    public static final String OPCION_CLICK_ESCRIBIR = "Click y escribir";

    public static final String OPCION_NEW_TAP = "New Tab";
    public static final String OPCION_NEW_WINDOW = "New Window";
    public static final String OPCION_NEW_WINDOW_MESSAGE = "New Window Message";
